...
public class PaymentController extends BaseController {
  ...
  /**
   * Validate the input date which should be in the format "mm/yy", and then return a {@link
   * java.lang.String String} representing the date in the required format "mmyy" .
   *
