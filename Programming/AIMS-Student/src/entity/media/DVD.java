...
public class DVD extends Media {
  ...
  public DVD(int id, String title, String category, int price, int quantity, String type,
      String discType,
      String director, int runtime, String studio, String subtitles, Date releasedDate,
  ...
  public String toString() {
    return "{" + super.toString() + " discType='" + discType + "'" + ", director='" + director + "'"
        + ", runtime='"
        + runtime + "'" + ", studio='" + studio + "'" + ", subtitles='" + subtitles + "'"
        + ", releasedDate='"
  ...
  public Media getMediaById(int id) throws SQLException {
    ...
    if (res.next()) {
      ...
      return new DVD(id, title, category, price, quantity, type, discType, director, runtime,
