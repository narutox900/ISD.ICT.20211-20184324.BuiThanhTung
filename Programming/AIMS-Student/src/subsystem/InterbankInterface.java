...
/**
 * The {@code InterbankInterface} class is used to communicate with the {@link
 * subsystem.InterbankSubsystem InterbankSubsystem} to make transaction
 *
 * @author hieud
 */
public interface InterbankInterface {
   ...
   * @return {@link entity.payment.PaymentTransaction PaymentTransaction} - if the payment is
   * successful
