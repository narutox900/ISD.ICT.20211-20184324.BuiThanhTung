...
public class ShippingScreenHandler extends BaseScreenHandler implements Initializable {
  ...
  public ShippingScreenHandler(Stage stage, String screenPath, RushOrder rushOrder)
      throws IOException {
    super(stage, screenPath);
    this.order = null;
  ...
  public void initialize(URL arg0, ResourceBundle arg1) {
    final BooleanProperty firstTime = new SimpleBooleanProperty(
        true); // Variable to store the focus on stage load
  ...
  public void createInvoiceScreen() throws IOException {
    ...
    if (order == null) {
      invoice = getBaseController().createInvoice(order);
    } else {
      invoice = getBaseController().createInvoice(rushOrder);
    }
