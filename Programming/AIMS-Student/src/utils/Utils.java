...
public class Utils {
  ...
  /**
   * Return a {@link java.lang.String String} that represents the current time in the format of
   * yyyy-MM-dd HH:mm:ss.
   *
  ...
  /**
   * Return a {@link java.lang.String String} that represents the cipher text encrypted by md5
   * algorithm.
   *
