...
/**
 * The {@link utils.MyMap JSON} class represents JSON objects. To create a new JSON object, JSON
 * jsonObject = new JSON(); jsonObject.put("key", value);
 *
 * @author hieud
 */
public class MyMap extends LinkedHashMap<String, Object> {
   ...
   * @author hieudm https://hg.openjdk.java.net/jdk8/jdk8/jdk/file/tip/src/share/classes/java/util/Hashtable.java
   */
...
//			}
  ...
  /**
   * Return a {@link java.util.Map Map} that represents the mapping among attribute names and their
   * values of an object.
   *
   * @param obj - an arbitrary {@link java.lang.Object Object}.
   * @return a {@link java.util.Map Map} mapping the attribute names and its values.
   * @throws IllegalAccessException
   * @throws IllegalArgumentException
   * @author hieudm https://stackoverflow.com/questions/52406467/convert-object-to-map-in-java
   */
  public static Map<String, Object> toMyMap(Object obj)
  ...
  /**
   * Return a {@link java.lang.String String} that represents the term in between 2 double quote.
   *
   * @param str - {@link java.lang.String String} idx - the index of the open quote
  ...
  /**
   * Return a {@link utils.MyMap MyMap} that represents the interested substring in a {@link
   * java.lang.String String}.
   *
   * @param str - {@link java.lang.String String} idx - the index of the first character in the
   *            interested substring in the {@link java.lang.String String}
